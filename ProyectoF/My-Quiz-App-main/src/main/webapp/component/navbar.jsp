        ...
        <a class="navbar-brand" href="<%= pageUrls.get("home") %>">
            <a href="<%= pageUrls.get("home") %>" style="color: black; text-decoration: none;">
                ...
                { %>                       
                   ...
                   style="width: 2rem; margin-right: 5px;"> Trivia</h2>
                <% } else { %>
             ...
             <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<%= pageUrls.get("quizze1") %>" >Geografia Mundial</a></li>
                        <li><a class="dropdown-item" href="<%= pageUrls.get("quizze2") %>" >Ciencia</a></li>
                        <li><a class="dropdown-item" href="<%= pageUrls.get("quizze3") %>" >Arte</a></li>
                        <li><a class="dropdown-item" href="<%= pageUrls.get("quizze4") %>" >Computacion</a></li>
                ...
                %>
                <li class="nav-item">
                    <a class="nav-link" href="<%= pageUrls.get("results") %>" >Resultados</a>
                </li>
                <%}
                %>
                
                <li class="nav-item">
                    <a class="nav-link" href="<%= pageUrls.get("leaderboard") %>" >Tabla de clasificación</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<%= pageUrls.get("about") %>" >Acerca de Nosotros</a>
                </li>
                
                <li class="nav-item">
                    <% if (!isLogin) 
                { %>
                    <a class="nav-link" href="<%= pageUrls.get("login") %>" >Iniciar Sesión</a>
                <% } else { %>
                    <a class="nav-link" href="<%= pageUrls.get("logout") %>" >Salir</a>
                <% }
                %> 
                </li>
